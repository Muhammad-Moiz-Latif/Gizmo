    ...
    const devices = await Promise.all([
        ...
        prisma.device.create({
            data: {
                ...
                Quantity: 15,
                Price: 1199.99,
                Description: "Latest flagship iPhone with A17 Pro chip, 48MP camera, and titanium design",
                Images: [
        ...
        prisma.device.create({
            data: {
                ...
                Quantity: 10,
                Price: 1899.99,
                Description: "15.6-inch OLED laptop with Intel Core i9, RTX 4090, premium aluminum chassis",
                Images: [
                    "https://images.unsplash.com/photo-1529277525253-cf7f0526f68e?w=500&h=500&fit=crop",
                    "https://images.unsplash.com/photo-1517336714731-489689fd1ca8?w=500&h=500&fit=crop",
        ...
        prisma.device.create({
            data: {
                ...
                Quantity: 14,
                Price: 299.99,
                Description: "AMOLED smartwatch with Exynos W920 processor and health monitoring",
                Images: [
                    "https://images.unsplash.com/photo-1611591437281-460bfbe1220a?w=500&h=500&fit=crop",
                    "https://images.unsplash.com/photo-1523275335684-37898b6baf30?w=500&h=500&fit=crop",
    ...
    const additionalDeviceData = [
        {
            ...
            Condition: "New", SerialNumber: "PIXEL9PRO", status: "CONFIRMED",
        },
        {
            ...
            Condition: "New", SerialNumber: "ONEPLUS12", status: "CONFIRMED",
        },
        {
            ...
            Condition: "New", SerialNumber: "THINKPADX1", status: "CONFIRMED",
        },
        {
            ...
            Condition: "New", SerialNumber: "ROGG16", status: "CONFIRMED",
        },
        {
            ...
            Condition: "New", SerialNumber: "SURFACE11", status: "CONFIRMED",
        },
        {
            ...
            Condition: "New", SerialNumber: "FIREMAX11", status: "CONFIRMED",
        },
        {
            ...
            Condition: "New", SerialNumber: "BOSEQCULTRA", status: "CONFIRMED",
        },
        {
            ...
            Condition: "New", SerialNumber: "JBLLIVEPRO2", status: "CONFIRMED",
        },
        {
            ...
            Condition: "New", SerialNumber: "PIXELWATCH3", status: "CONFIRMED",
        },
        {
            ...
            Condition: "New", SerialNumber: "GARMINVENU3", status: "CONFIRMED",
        },
    ];
    const additionalDevices = await Promise.all(additionalDeviceData.map((data) => prisma.device.create({ data })));
