...
export default function CategoriesPage() {
  ...
  const handleAddCategory = async () => {
    ...
    try {
      const response = await axios.post(`${import.meta.env.VITE_PUBLIC_API_URL}/AdminDashboard/AddCategory`, formData, {
  ...
  const handleRemoveCategory = async (categoryId: string) => {
    ...
    try {
      await axios.post(`${import.meta.env.VITE_PUBLIC_API_URL}/AdminDashboard/DeleteCategory/${categoryId}`);
